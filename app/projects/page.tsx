...
const projects = [
  {
    ...
    description: "Official Discord server website for Europa Universalis IV fans. The project enables users to access information about events, gameplay rules, and multiplayer session schedules.",
  ...
  },
  {
    ...
    description: "Advanced cryptocurrency trading bot using the Freqtrade platform. The project utilizes machine learning techniques to optimize investment decisions.",
  ...
  },
  {
    ...
    description: "Application for automatic generation and management of Excel reports. The solution automates data analysis and reporting processes.",
